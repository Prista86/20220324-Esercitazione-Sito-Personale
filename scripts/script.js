...
function StampaListaPartecipanti() { //completa la tabella con le info della classee
    ...
    <div class="card">
        <div class="accordionCol card-header">
            <p class="collapsed btn" data-bs-toggle="collapse" href="#collapseOne">
                Clicca per vedere la foto!!!
            </p>
        </div>
        <div id="collapseOne" class="accordionCol collapse" data-bs-parent="#accordion">
            <div class="card-body">
                <p>Foto: </p><img id="img1" src="${ListaPartecipanti[indice].immagine}" class="rounded mx-auto center" alt="Torno Subito...">
            </div>
        </div>
    </div>    
    `
